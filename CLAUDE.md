...
A holding repo for raw transcripts. No code, no build, no tests.

Current contents: `10-08-2024 Future of Sound Raw Transcript` (extensionless) and a VS
Code workspace file.

## Conventions

Files are dated `MM-DD-YYYY <Event Name> Raw Transcript`. Raw means unedited machine
